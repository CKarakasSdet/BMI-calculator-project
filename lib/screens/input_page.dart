...
/*
to create border, we can use decoration property

color out of decoration property will crash because color is actually coming from
decoration property.
...
(the warning before we added the final key word).
Reason:
